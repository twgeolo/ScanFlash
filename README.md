...
There are five default categories in ScanFlash: Gallery, All, Favorite, Recommended, and Settings. Gallery contains all pictures taken by the user. All has flashcards made from the pictures in the order they were taken in with the option to add flashcards to the Favorite tab. Recommended will have ten flashcards regenerated by the application per week having a variety of difficulty. Settings will allow users to change which language the words are translated into.

APIs Used: Tesseract, Google Translate
